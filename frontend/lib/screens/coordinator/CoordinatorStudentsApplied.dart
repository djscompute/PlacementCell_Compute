...
class CompanyStudentsAppliedIn extends StatefulWidget {
  final String companyEmail;
  final List<int> studentsApplied;
  const CompanyStudentsAppliedIn(
      {required this.companyEmail, required this.studentsApplied});

  @override
  State<CompanyStudentsAppliedIn> createState() =>
      _CompanyStudentsAppliedInState();
}

class _CompanyStudentsAppliedInState extends State<CompanyStudentsAppliedIn> {
  @override
